...
export default class Inscription extends React.Component{
    ...
    continue = () => {
        ...
        //console.log( connection("Admin", "1234"));
        alert(connection("Admin", "1234"))
    };
        ...
        return(
            <View style={styles.container}>
                ...
                <View style = {styles.SeConnecter}>
                    <Text style={{color: "#514E5A", fontSize: 18}}>No account</Text>
                </View>
                ...
                <TouchableOpacity style={styles.deco}>
                    <Text style={{fontSize: 20, marginLeft:10, marginTop: 4, color:"#514E5A"}} >Registration</Text>
                </TouchableOpacity>
